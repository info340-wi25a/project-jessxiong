...
export function CardListNotes(props) {
    ...
    const cardTitleArray = titleNames.map((note) => {
        const transformed = <CardNotes key={note.title} title={note.title} subjecttitle={subjecttitle} handleDelete={handleDelete} />;
        return transformed
    })
